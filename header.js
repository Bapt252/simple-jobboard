            ...
            <div class="header-left">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="post-job.html" class="${currentPage === 'post-job.html' ? 'active' : ''}">Offres d'emploi</a></li>
                    </ul>
                </nav>
            </div>
            <div class="auth-buttons">
                <a href="candidate-login.html" class="btn-auth ${currentPage === 'candidate-login.html' ? 'active' : ''}">Espace candidat</a>
                <a href="recruiter-login.html" class="btn-auth btn-auth-primary ${currentPage === 'recruiter-login.html' ? 'active' : ''}">Espace recruteur</a>
            </div>
        </div>
        `;
